            ...
            <div className="flex items-center space-x-4 pt-8">
              <button className="w-14 h-14 bg-white border border-speech-green rounded-full flex items-center justify-center hover:bg-speech-green hover:text-white transition-colors group">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" clipRule="evenodd" d="M12.7071 6.29289C13.0976 6.68342 13.0976 7.31658 12.7071 7.70711L9.41421 11H17C17.5523 11 18 11.4477 18 12C18 12.5523 17.5523 13 17 13H9.41421L12.7071 16.2929C13.0976 16.6834 13.0976 17.3166 12.7071 17.7071C12.3166 18.0976 11.6834 18.0976 11.2929 17.7071L6.29289 12.7071C5.90237 12.3166 5.90237 11.6834 6.29289 11.2929L11.2929 6.29289C11.6834 5.90237 12.3166 5.90237 12.7071 6.29289Z" className="fill-speech-green group-hover:fill-white"/>
                </svg>
              </button>
              ...
              <button className="w-14 h-14 bg-speech-green rounded-full flex items-center justify-center hover:bg-speech-green/90 transition-colors">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path fillRule="evenodd" clipRule="evenodd" d="M7.29289 6.29289C6.90237 6.68342 6.90237 7.31658 7.29289 7.70711L10.5858 11H3C2.44772 11 2 11.4477 2 12C2 12.5523 2.44772 13 3 13H10.5858L7.29289 16.2929C6.90237 16.6834 6.90237 17.3166 7.29289 17.7071C7.68342 18.0976 8.31658 18.0976 8.70711 17.7071L13.7071 12.7071C14.0976 12.3166 14.0976 11.6834 13.7071 11.2929L8.70711 6.29289C8.31658 5.90237 7.68342 5.90237 7.29289 6.29289Z" fill="white"/>
                </svg>
              </button>
            </div>
          </div>
